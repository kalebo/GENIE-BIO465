...
genie.subsets.cn.profiles <- readRDS("genie.subsets.cn.profiles.rds")
gdsc.subsets.cn.profiles <- readRDS("Drug-Profile-Table.rds")
genie.subsets2060.cn.profiles <- readRDS("latest.genie.subsets.cn.profile.rds")
```
...
```{r}
genie.test <- filter(genie.subsets.cn.profiles, CN_LEVEL != 0)
testResult <- generateTumourDrugMatrix(genie.test[1:4,], gdsc.subsets.cn.profiles, c(-2,2))
```
